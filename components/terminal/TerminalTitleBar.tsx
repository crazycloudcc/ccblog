...
export const TerminalTitleBar = forwardRef<HTMLDivElement, TerminalTitleBarProps>(
  function TerminalTitleBar({ title, onDoubleClick }, ref) {
    ...
    return (
      <div
        ...
        className="terminal-chrome flex shrink-0 cursor-grab items-center gap-2 border-b border-lavender-mist bg-lavender-mist/60 px-4 py-2.5 font-mono text-xs text-fog active:cursor-grabbing"
      >
